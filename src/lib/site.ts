...
const basePages: BasePage[] = [
  {
    ...
    group: "solutions",
    title: "Brixs ZK-Rollup",
    eyebrow: "Core execution layer",
    summary: "Native EVM execution powered by a ZK-SNARK Prover Engine and DPoS for sub-second block times.",
    detail:
      "Brixs Chain is a highly-sophisticated ZK-Rollup (Chain ID: 7777777). It generates mathematical proofs of block execution, making the chain infinitely scalable while inheriting Ethereum's security.",
    bullets: [
      "Decentralized Sequencer (DPoS) eliminates centralized failure points.",
  ...
  },
  {
    ...
    summary: "Lattice-based signature verification layer for future-proof security.",
    detail:
      "Brixs Chain is the first EVM Rollup future-proofed against Quantum Computers. We utilize advanced lattice-based cryptography to secure all network state.",
    bullets: [
      "Quantum-resistant signature verification.",
      "Protects network from future cryptographic threats.",
  ...
  },
  {
    ...
    summary: "Protects users against MEV sandwich attacks by encrypting transactions before they are ordered.",
    detail:
      "Brixs Chain features a native encrypted mempool. Transactions are shielded from malicious validators and searchers, ensuring fair execution and eliminating front-running.",
    bullets: [
      "Native protection against MEV and sandwich attacks.",
      "Transactions are encrypted before ordering.",
  ...
  },
  {
    ...
    group: "use-cases",
    title: "Agentic AI Intents",
    eyebrow: "Protocol-level automation",
    summary: "Protocol-Level Autonomous AI Agents built directly into the core network.",
    detail:
      "Users deposit funds into the BrixsAIAgent.sol smart contract, and the Node's AI Intent Engine autonomously executes complex trading strategies or payments on their behalf.",
    bullets: [
      "Native AI Intent Engine deployed at the node level.",
      "Deposit into BrixsAIAgent.sol for automated portfolio management.",
