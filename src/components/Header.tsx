...
const menus: Record<string, MenuItem[]> = {
  ...
  Solutions: [
    ...
    { title: "Post-Quantum Crypto", subtitle: "Lattice-based security.", icon: <Shield size={20} strokeWidth={1.5} />, href: "/solutions/brixs-agglayer" },
    { title: "Encrypted Mempool", subtitle: "MEV Protection.", icon: <Shield size={20} strokeWidth={1.5} />, href: "/solutions/vaultbridge" },
  ...
  "Use Cases": [
    ...
    { title: "Agentic AI", subtitle: "Protocol-level automation.", icon: <Bot size={20} strokeWidth={1.5} />, href: "/use-cases/agentic-ai" },
